...
sudo scutil --set ComputerName "bbPro"
sudo scutil --set HostName "bbPro"
sudo scutil --set LocalHostName "bbPro"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "bbPro"
...
sudo ln -s https://w.wallhaven.cc/full/g7/wallhaven-g7dyqe.jpg /System/Library/CoreServices/DefaultDesktop.jpg
